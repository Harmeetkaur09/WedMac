        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 mb-8 font-poppins text-xl">
              By accessing or using the WedMac India platform, you (User/Artist
              or Client ) agree to comply with these Terms and Conditions. If
            ...
            <p className="text-gray-600 mb-8 font-poppins">
              WedMac India operates as a digital platform that connects
              professional bridal makeup artists with verified and
              high-converting potential clients across India.
            </p>

            <p className="text-gray-600 mb-2 font-poppins">
              We are not a beauty service provider ourselves, but a lead
              generation and marketing partner to help makeup artists grow their
            ...
            <ul className="text-gray-600 mb-8 font-poppins list-disc pl-5">
              ...
              <li>
                {" "}
                Business growth support via promotion and brand visibility
              </li>
            </ul>
            ...
            <ul className="text-gray-600 mb-8 font-poppins list-disc pl-5">
              ...
              <li>
                Own or work as a certified/professional bridal makeup artist
              </li>
              <li>
                Have a valid mobile number, email ID, and government-issued ID
              </li>
            </ul>

            <p className="text-gray-600 mb-8 font-poppins">
              We reserve the right to verify and reject registrations that do
              not meet our internal verification standards.
            </p>
            ...
            <ul className="text-gray-600 mb-8 font-poppins list-disc pl-5">
              <li>
                Leads shared by WedMac India are collected through online
                promotions, ads, and inquiries.
              </li>
              <li>
                We aim to provide verified and high-quality leads, but do not
                guarantee conversion into bookings.
              </li>
              <li>
                Artists are solely responsible for follow-ups, client
            ...
            <ul className="text-gray-600 mb-8 font-poppins list-disc pl-5">
              <li>
                Access to our leads is provided via paid subscription plans, the
                details of which are available on our platform or shared by our
                team.
              </li>
              <li>
                No refunds shall be issued for used leads or after a certain
                lead count has been delivered.
              </li>
              <li>
                Invoices and payment receipts will be shared post-confirmation.
              </li>
            </ul>
            ...
            <h1 className="text-2xl font-bold mb-6 font-poppins">
              {" "}
              The artist assumes full responsibility for client interactions and
              service fulfillment.
            </h1>
          </div>
        </div>
